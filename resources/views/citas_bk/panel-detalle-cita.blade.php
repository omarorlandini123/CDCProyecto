        ...
        <div class="mdc-layout-grid__inner">
            <div class="mdc-layout-grid__cell 
                ...
                <div class="text-field-container">
                    <div class="mdc-text-field text-field mdc-text-field--with-leading-icon mdc-ripple-upgraded caja-detalle-cita"
                        ...
                        <input type="hidden" value="" name="txt_medico">
                        <input disabled type="text" id="text-field-filled-leading" class="mdc-text-field__input">
                        <label class="mdc-floating-label" for="text-field-filled-leading">Médico</label>
            ...
            <div class="mdc-layout-grid__cell 
             ...
             mdc-layout-grid__cell--span-4-phone">
                <div class="mdc-select select-100">
                    ...
                    <span class="mdc-floating-label">Especialidad</span>
             ...
             mdc-layout-grid__cell--span-4-phone">
                <div class="text-field-container">
                    <div class="mdc-text-field text-field mdc-text-field--with-leading-icon mdc-ripple-upgraded caja-detalle-cita"
                        ...
                        <label class="mdc-floating-label" for="text-field-filled-leading">Fecha de cita</label>
                        <div class="mdc-line-ripple" style="transform-origin: 99.5px center 0px;"></div>
                    </div>
                    <p class="mdc-text-field-helper-text mdc-text-field-helper-text--persistent mdc-text-field-helper-text--validation-msg"
                        id="pw-validation-msg"></p>
            ...
            <div class="mdc-layout-grid__cell 
             ...
             mdc-layout-grid__cell--span-4-phone">
                <div class="mdc-select select-100">
                    ...
                    <span class="mdc-floating-label">Horario</span>
                    <div class="mdc-line-ripple"></div>
                </div>
            ...
            <div class="mdc-layout-grid__cell 
             ...
             mdc-layout-grid__cell--span-4-phone">
                <div class="mdc-select select-100">
                    ...
                    <span class="mdc-floating-label">Aseguradora</span>
                    <div class="mdc-line-ripple"></div>
                </div>
                ...
                <div class="text-field-row text-field-row-fullwidth">
                    <div class="text-field-container">
                        <div class="mdc-text-field text-field mdc-text-field--fullwidth mdc-text-field--textarea">
                            <textarea id="text-field-fullwidth-textarea-helper" class="mdc-text-field__input"></textarea>
                            <div class="mdc-notched-outline mdc-notched-outline--upgraded">
                                <div class="mdc-notched-outline__leading"></div>
                                <div class="mdc-notched-outline__notch" style="">
                                    <label class="mdc-floating-label" for="text-field-fullwidth-textarea-helper" style="">Notas adicionales</label>
                                </div>
