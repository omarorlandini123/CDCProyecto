  ...
  <div class="panel-movil-contenido">
        ...
        <div class="mdc-top-app-bar__row">
          <section class="seccion-inicio">
            ...
            <span class="mdc-top-app-bar__title" style="font-size: 1em;">
              ...
              >DNI: {{citasel.historia.persona_historia.dni}} - Historia: {{citasel.historia.id}}</p>
            </span>
          </section>
    ...
    <div class="panel-movil">
      <div class="panel-detalle-cita" style="position:relative;">
        ...
        >Datos de la cita - {{citasel.id}}</h3>
          ...
          <div class="mdc-layout-grid__inner">
                ...
                <div class="mdc-select__menu mdc-menu mdc-menu-surface select-25">
                  <ul class="mdc-list">
                    <li
                      ...
                      v-bind:class="{
                        'mdc-list-item':true,
                        'mdc-list-item--selected':medicosel.id==medico.id,
                      }"
                      :aria-selected="medicosel.id==medico.id"
                ...
                <div class="mdc-select__menu mdc-menu mdc-menu-surface select-25">
                  <ul class="mdc-list">
                    <li
                      ...
                      v-bind:class="{
                      'mdc-list-item':true,
                      'mdc-list-item--selected':especialidadsel.id==especialidad.id,
                    }"
                      :aria-selected="especialidadsel.id==especialidad.id"
            ...
            >
              <div class="mdc-select sel-motivo select-100 mdc-ripple-surface">
                ...
                <div class="mdc-select__selected-text">
                  {{
                  motivosel!=null?motivosel.nombre:''
                  }}
                </div>
                <div class="mdc-select__menu mdc-menu mdc-menu-surface select-25">
                  <ul class="mdc-list">
                    <li
                      ...
                      v-bind:class="{ 
                       'mdc-list-item': true,
                       'mdc-list-item--selected':motivosel.id==motivo.id,
                      }"
                      :aria-selected="motivosel.id==motivo.id"
                ...
                <div class="mdc-select__menu mdc-menu mdc-menu-surface select-25">
                  <ul class="mdc-list">
                    <li
                      ...
                      v-bind:class="{ 
                       'mdc-list-item': true,
                       'mdc-list-item--selected':aseguradorasel.id==aseguradora.id,
                      }"
